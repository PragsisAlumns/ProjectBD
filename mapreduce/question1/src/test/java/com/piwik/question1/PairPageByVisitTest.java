...
public class PairPageByVisitTest {
	...
	public void setUp() {
		...
		PairPageByVisitMapper routeByIdVisitMapper = new PairPageByVisitMapper();
		...
		PairPageByVisitReducer routeByIdVisitReducer = new PairPageByVisitReducer();
